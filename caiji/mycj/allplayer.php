...
<html>
<head>
<title>小刀资源采集插件 - 一键替换本地播放器</title>
...
<div class="page-container p10">
	...
	&nbsp;<b>温馨提示：</b>新手不会操作的，联系邮箱请教！邮箱：admin@52xd.tv<br>
    </blockquote>
	</div>
...
<script type="text/javascript" src="./jspojie/main.min.js?v=<?php echo time();?>"></script>
<script type="text/javascript" src="./js/allplayer.js?v=<?php echo time();?>"></script>
