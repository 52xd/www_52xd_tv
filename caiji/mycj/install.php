...
<body>
<div class="header">
    <h1>感谢您选择『小刀资源多功能综合采集插件』苹果CMS-V10版</h1>
</div>
<div class="install-box">
    <fieldset class="layui-elem-field site-demo-button">
        ...
        <div class="protocol">
            <p>
                本插件由小刀影院（www.52xd.tv）收集整理破解。PS：由官方收费版(萌芽收费60RMB)整理破解 <br /><br />
                一、插件介绍： <br /> <br />
                本插件为 <b>破解版</b>！ 功能与 <b>官方收费版</b>99%一致，唯一没破解的功能是：自定义添加资源站！<b style="color:#FF5722">此插件可使用自定义播放配置、一键定时任务、一键加入收藏、多线程采集、一键搜索最新资源、批量修改播放器、视频断点采集、一键获取影视幻灯片图片链接等 </b><br /><br />
                二、重要声明：  <br /> <br />
                ...
                <strong>本插件版权所有 (c) 2020，小刀影院（www.52xd.tv）,保留所有权利</strong>。
            </p>
        </div>
    </fieldset>
    <div class="step-btns">
...
<script src="./js/update.js?v=<?php echo time();?>" type="text/javascript" charset="utf-8"></script>
<script>
