...
if (comm.cookie.get('guide')!=1 && !is_wap()) {
	...
	var enjoyhint_script_steps = [{
		'next #mycjv10': '欢迎使用小刀资源采集插件！<br>让我来引导你了解它的特点。',
		'skipButton': {
			className: "mySkip",
			text: "不了!"
		},
		...
		'next #user': '以上介绍的功能中，部分在官方收费版才能使用<br>官方收费版需要登陆验证成功后，即可使用VIP版功能<br>PS：此版本已破解，无需登陆可用全部功能！',
		'skipButton': {
			className: "myNext",
			text: "跳过"
		},
		...
		'click .qqlink': '更详细的教程，请观看采集插件视频使用教程<br>你也可以选择联系站长邮箱：admin@52xd.tv，获取更多帮助！<br>如果发现BUG，欢迎您的反馈！',
		'skipButton': {
			className: "myNext",
			text: "好的"
		}
