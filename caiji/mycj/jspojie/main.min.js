...
function tips() {
  var instance = layer.confirm(
    '免费版不支持此功能，<br>如有需要此功能，<br>请<a href="https://my.vrecf.com/mypay/?type=v10" class="layui-btn layui-btn-xs" target="_blank">点此购买VIP</a><br>购买后请点击立即登陆<br>PS：如出现此窗口说明插件已失效或插件已更新，请立即反馈站长说明缘由，站长邮箱：admin@52xd.tv',
    {
      title: "提示",
      btn: ["立即登录","取消"]
    },
...
$(document).on("click", ".qqlink", function () {
  if (!is_vip) {
    var layero = layer.confirm("免费版不提供技术支持，<br>不能加入交流群，仅供自个儿研究<br>是否登陆升级VIP版？<br>PS：如出现此窗口说明插件已失效或插件已更新，请立即反馈站长说明缘由，站长邮箱：admin@52xd.tv", {
      title: "提示",
      btn:  ["立即登陆", "取消"]
    }, function () {
      layer.close(layero);
