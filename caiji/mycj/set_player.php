...
<head>
    ...
    <title>播放器配置 - 小刀资源采集插件</title>
    <link rel="stylesheet" href="<?php echo $my['site']['install_dir'];?>static/layui/css/layui.css">
    <link rel="stylesheet" href="<?php echo $my['site']['install_dir'];?>static/css/admin_style.css">
    <script type="text/javascript" src="<?php echo $my['site']['install_dir'];?>static/js/jquery.js"></script>
    <script type="text/javascript" src="<?php echo $my['site']['install_dir'];?>static/layui/layui.js"></script>
    ...
    <form class="layui-form layui-form-pane">
        <div class="layui-tab">
            <blockquote class="layui-elem-quote layui-quote-nm mt10">
			  <p style="color:red">本插件提供的默认解析接口为：https://www.52xd.tv/v/?url=，此接口免费提供，移动端播放会有广告！</p>
              <p class="f-20 text-success">推荐安装本地播放器，如DPlayer、CKplayer等播放器，第三方解析接口可加载广告或者劫持流量。</p><span id="text_tips"></span>
            </blockquote>
            <div class="layui-tab-content">
			    <div class="layui-tab-item layui-show jie-kou">
                    <div class="layui-form-item" id="all-jie-kou">
				        ...
				        <span id="local_player" style="margin-left: 10px;">
				...
				echo '<div class="layui-form-item">
                    ...
                    <div class="layui-form-item jie-kou">
                        ...
                        <div class="layui-input-inline" id="jiekou" style="width:54%">
                            <input type="text" class="layui-input layui-disabled" disabled value="https://www.52xd.tv/v/?url=" placeholder="请输入解析接口" id="apis_'.$i.'" name="play[apis][]">
                        </div>
...
<script type="text/javascript" charset="utf-8" src="./jspojie/main.min.js?v=<?php echo time();?>"></script>
<script type="text/javascript" src="./jspojie/set-player.js?v=<?php echo time();?>"></script>
</body>
</html>