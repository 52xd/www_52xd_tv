...
<head>
<meta charset="utf-8">
<title>DPlay播放器设置 - 小刀影院</title>
    <link href="https://cdn.jsdelivr.net/gh/52xd/www_52xd_tv/maccms10/static/layui/css/layui.css" rel="stylesheet" type="text/css" />
    <script src="https://cdn.jsdelivr.net/gh/52xd/www_52xd_tv/maccms10/static/layui/layui.js" type="text/javascript" charset="utf-8"></script>
	<script src="https://cdn.jsdelivr.net/gh/52xd/www_52xd_tv/maccms10/static/js/jquery.js"></script>
	<style>
	.layui-input-inline textarea{min-width:300px;min-height:150px;}
	.layui-form-item .layui-form-label{min-width:130px;}
	</style>
</head>
<body style="margin:20px 20px">
<style>
.showpic {position:absolute; max-width:400px; max-height:500px; text-align:center; line-height:150%; border:2px solid #DEEFFA; padding:5px; background:#FFFFFF;  z-index:99999;}
</style>
<div class="showpic" style="display:none;"><img class="showpic_img" width="100%" height="100%"></div>
<form class="layui-form layui-form-pane" action="">
<div class="layui-tab">
  <ul class="layui-tab-title">
    <li class="layui-this">DPlay播放器</li>
    <li>基础设置</li>
    <li>前置广告设置</li>
    <li>暂停广告设置</li></ul>
  <div class="layui-tab-content">
    <div class="layui-tab-item layui-show">
      <blockquote class="layui-elem-quote layui-quote-nm">
        <p>欢迎使用小刀影院 整合的苹果cmsV10 DPlay播放器</p>
      </blockquote>
      <table class="layui-table">
        ...
        <tbody>
          <tr>
            <td>名称</td>
            <td>
              <a href="https://www.52xd.tv/" target="_blank">Dplayer播放器3.1.1</a></td>
            <td>1. PHP版本≥5.6</td></tr>
          <tr>
            <td>作者</td>
            <td>
              <a href="https://www.52xd.tv/" target="_blank">小刀影院</a></td>
            <td>2. 唯一官方网站，其他网站购买到本源码均为二次倒卖！</td></tr>
          <tr>
            <td>官方网站</td>
            <td>
              <a href="https://www.52xd.tv/" target="_blank">https://www.52xd.tv/</a></td>
          ...
          <tr>
            <td>作者邮箱</td>
            <td>admin@52xd.tv</td>
            <td>5. 唯一官方邮箱，购买非官方制作源码，无任何技术支持及售后服务！</td></tr>
          <tr>
            <td>更新时间</td>
            <td>
              <a href="https://www.52xd.tv/" target="_blank">2020-06-29</a></td>
            <td>7. 肆意散播转售或者倒卖，将视为放弃一切技术支持</td></tr>
          <tr>
            <td colspan="3" style="color:red;">DPlay播放器 调用接口：https://<?php echo $_SERVER['HTTP_HOST'];?>/addons/dplayer/?url=</td></tr>
          <tr>
		  <tr>
    ...
    <div class="layui-tab-item">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-mid layui-word-aux">填写地址需带http(s)://</div></div>		  		  
        <div class="layui-form-item">
          ...
          <div class="layui-form-mid layui-word-aux">播放器右上角logo，建议尺寸195*55</div></div>
        <div class="layui-form-item">
    ...
    <div class="layui-tab-item">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
			...
			<div class="layui-form-mid layui-word-aux">链接必须带http(s)://，视频格式必须是.mp4或者.m3u8，广告视频有多少秒就播放多少秒，不能跳过</div>
        </div>
        <div class="layui-form-item">
          ...
          <div class="layui-input-inline">
			...
			<div class="layui-form-mid layui-word-aux">链接必须带http(s)://，点击视频广告跳转的地址</div>
        </div>		
        <div class="layui-form-item">
          <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="systemsave">保存配置</button></div>
