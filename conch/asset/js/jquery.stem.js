...
var ikan = {
	...
	mobile: {
		...
		xiaoshuo: function() {
			ikan.browser.useragent.weixin ? $("#xiao").after('<li><a rel="nofollow" href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzI1MjM2MTM3NQ==&scene=124#wechat_redirect" target="_blank">小说</a></li>') : $("#xiao").after()
		}
	},
	swiper: function() {
